        ...
        <div class="container">
            <section id="content">
                <form action="">
                    <h1>Login Form</h1>
                    <div>
                        <input id="username" type="text" placeholder="Username" required="" id="username" />
                    </div>
                    <div>
                        <input id="password" type="password" placeholder="Password" required="" id="password" />
                    </div>
                    <div>
                ...
                $(document).ready(function () {
                    $('#submit').click(function () {
                        ...
                        if (username.length === 0 || password.length === 0) {
                            alert('username and password field msut noot be empty')
                        } else {
                            $.ajax({
                                url: '/login-user',
                                type: 'post',
